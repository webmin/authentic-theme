...
<div class="table-responsive">
  ...
  . $Atext{'settings_right_options'} . '</b></th></tr></thead>
        <tbody>
            <tr>
                <td>
...
'" style="display: inline; width: 40px; height: 28px; margin-right: 0px !important; margin-bottom: 2px !important; margin-left: 2px;" type="button"'
  . (-r $root_directory . "/$current_theme/images/logo.png" &&
...
'" style="display: inline; width: 40px; height: 28px; margin-right: 0px !important; margin-bottom: 2px !important; margin-left: 2px;" type="button"'
  . (-r $root_directory . "/$current_theme/images/logo_welcome.png" &&
