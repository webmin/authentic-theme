    ...
    if ( &foreign_available("system-status") ) {
        ...
        if ( $remote_version <= $installed_version ) {
            ...
            $authentic_theme_version
                ...
                . '<a class="btn btn-xxs btn-warning" target="_blank" href="https://github.com/qooob/authentic-theme/releases/download/18.30/authentic-theme-18.30.wbt.gz"><i class="fa fa-fw fa-download">&nbsp;</i>'
