...
var $_url = $.url(t___wi.location),
	...
	$g__o__f_m = ("file" + (is_module("file-manager") ? "-manager" : "min"));
if ($webprefix) {
...
var $g__e__path = $_____link_full + "/extensions";
...
function shortcut_control(b) {
	if (settings_hotkeys_active) {
		...
		if (String.fromCharCode(b.which).toLowerCase() == settings_hotkey_reload && t__wi_p.$('.user-links a[data-refresh="true"]')) {
			b.preventDefault();
			if (t__wi_p.$('iframe[name="page"]') && t__wi_p.$('iframe[name="page"]').attr("src") && t__wi_p.$('iframe[name="page"]').attr("src").indexOf($g__o__f_m) > -1) {
	...
	if ($current_page_full == $_____link_full + "/custom/" || $current_page_full == $_____link_full + "/custom/index.cgi" || $current_page_full == $_____link_full + "/backup-config/" || $current_page_full == $_____link_full + "/backup-config/index.cgi" || $current_page_full == $_____link_full + "/usermin/" || $current_page_full == $_____link_full + "/usermin/index.cgi" || $current_page_full == $_____link_full + "/webmin/" || $current_page_full == $_____link_full + "/webmin/index.cgi" || $current_page_full == $_____link_full + "/acl/" || $current_page_full == $_____link_full + "/acl/index.cgi" || $current_page_full == $_____link_full + "/init/" || $current_page_full == $_____link_full + "/init/index.cgi" || $current_page_full == $_____link_full + "/mount/" || $current_page_full == $_____link_full + "/mount/index.cgi" || $current_page_full == $_____link_full + "/quota/" || $current_page_full == $_____link_full + "/quota/index.cgi" || $current_page_full == $_____link_full + "/fsdump/" || $current_page_full == $_____link_full + "/fsdump/index.cgi" || $current_page_full == $_____link_full + "/inittab/" || $current_page_full == $_____link_full + "/inittab/index.cgi" || $current_page_full == $_____link_full + "/logrotate/" || $current_page_full == $_____link_full + "/logrotate/index.cgi" || $current_page_full == $_____link_full + "/mailcap/" || $current_page_full == $_____link_full + "/mailcap/index.cgi" || $current_page_full == $_____link_full + "/pam/" || $current_page_full == $_____link_full + "/pam/index.cgi" || $current_page_full == $_____link_full + "/proc/" || $current_page_full == $_____link_full + "/proc/index_tree.cgi" || $current_page_full == $_____link_full + "/proc/index_user.cgi" || $current_page_full == $_____link_full + "/proc/index_size.cgi" || $current_page_full == $_____link_full + "/proc/index_cpu.cgi" || $current_page_full == $_____link_full + "/proc/index_tree.cgi" || $current_page_full == $_____link_full + "/proc/index_search.cgi" || $current_page_full == $_____link_full + "/cron/" || $current_page_full == $_____link_full + "/cron/index.cgi" || $current_page_full == $_____link_full + "/syslog/" || $current_page_full == $_____link_full + "/syslog/index.cgi" || $current_page_full == $_____link_full + "/useradmin/" || $current_page_full == $_____link_full + "/useradmin/index.cgi" || $current_page_full == $_____link_full + "/apache/" || $current_page_full == $_____link_full + "/apache/index.cgi" || $current_page_full == $_____link_full + "/bind8/" || $current_page_full == $_____link_full + "/bind8/index.cgi" || $current_page_full == $_____link_full + "/dhcpd/" || $current_page_full == $_____link_full + "/dhcpd/index.cgi" || $current_page_full == $_____link_full + "/dovecot/" || $current_page_full == $_____link_full + "/dovecot/index.cgi" || $current_page_full == $_____link_full + "/ldap-server/" || $current_page_full == $_____link_full + "/ldap-server/index.cgi" || $current_page_full == $_____link_full + "/virtualmin-nginx/" || $current_page_full == $_____link_full + "/virtualmin-nginx/index.cgi" || $current_page_full == $_____link_full + "/fetchmail/" || $current_page_full == $_____link_full + "/fetchmail/index.cgi" || $current_page_full == $_____link_full + "/mysql/" || $current_page_full == $_____link_full + "/mysql/index.cgi" || $current_page_full == $_____link_full + "/mysql/edit_dbase.cgi" || $current_page_full == $_____link_full + "/postgresql/" || $current_page_full == $_____link_full + "/postgresql/index.cgi" || $current_page_full == $_____link_full + "/postgresql/edit_dbase.cgi" || $current_page_full == $_____link_full + "/postfix/" || $current_page_full == $_____link_full + "/postfix/index.cgi" || $current_page_full == $_____link_full + "/procmail/" || $current_page_full == $_____link_full + "/procmail/index.cgi" || $current_page_full == $_____link_full + "/proftpd/" || $current_page_full == $_____link_full + "/proftpd/index.cgi" || $current_page_full == $_____link_full + "/mailboxes/" || $current_page_full == $_____link_full + "/mailboxes/index.cgi" || $current_page_full == $_____link_full + "/mailboxes/list_mail.cgi" || $current_page_full == $_____link_full + "/mailbox/" || $current_page_full == $_____link_full + "/mailbox/index.cgi" || $current_page_full == $_____link_full + "/samba/" || $current_page_full == $_____link_full + "/samba/index.cgi" || $current_page_full == $_____link_full + "/spam/" || $current_page_full == $_____link_full + "/spam/index.cgi" || $current_page_full == $_____link_full + "/squid/" || $current_page_full == $_____link_full + "/squid/index.cgi" || $current_page_full == $_____link_full + "/sshd/" || $current_page_full == $_____link_full + "/sshd/index.cgi" || $current_page_full == $_____link_full + "/webalizer/" || $current_page_full == $_____link_full + "/webalizer/index.cgi" || $current_page_full == $_____link_full + "/cpan/" || $current_page_full == $_____link_full + "/cpan/index.cgi" || $current_page_full == $_____link_full + "/htaccess-htpasswd/" || $current_page_full == $_____link_full + "/htaccess-htpasswd/index.cgi" || $current_page_full == $_____link_full + "/status/" || $current_page_full == $_____link_full + "/status/index.cgi" || $current_page_full == $_____link_full + "/net/" || $current_page_full == $_____link_full + "/net/index.cgi" || $current_page_full == $_____link_full + "/tcpwrappers/" || $current_page_full == $_____link_full + "/tcpwrappers/index.cgi" || $current_page_full == $_____link_full + "/fdisk/" || $current_page_full == $_____link_full + "/fdisk/index.cgi" || $current_page_full == $_____link_full + "/fail2ban/" || $current_page_full == $_____link_full + "/fail2ban/index.cgi" || $current_page_full == $_____link_full + "/nis/" || $current_page_full == $_____link_full + "/nis/index.cgi" || $current_page_full == $_____link_full + "/passwd/" || $current_page_full == $_____link_full + "/passwd/index.cgi") {
		$(t__wi_p.$('iframe[name="page"]').contents().find(".panel-body a[href]:not([href*='javascript'],[href*='list_users.cgi?dom'],[href*='edit_hdparm.cgi?disk'],[href*='blink.cgi?disk'],[href*='smart-status/index.cgi?drive'],[href*='help.cgi'],[href*='edit_user.cgi?new='],[href*='edit_user.cgi?idx='],[href*='edit_recipe.cgi'],[href*='up.cgi'],[href*='down.cgi'],[href*='virt_index.cgi'],[href*='save_log.cgi'],[href*='backup.cgi'],[href*='activate.cgi'],[href*='#'])")).each(function (a, b) {
			if ($current_page_full == $_____link_full + "/syslog/" || $current_page_full == $_____link_full + "/syslog/index.cgi") {
				...
				p[($(this).attr("href").substring(0, 1) == "/" ? "" : "/") + $current_directory + $(this).attr("href")] = $.trim($(this).text()) + ($_description ? " (" : "") + $description + ($_description ? ")" : "")
			}
		})
	}
...
function __p__pe_sm() {
	if (($("textarea#data, textarea#text, textarea#directives").length === 1) && ($("textarea#data, textarea#text, textarea#directives").parents("form").find('input[type="submit"]').length === 1)) {
		$(".ui_reset").remove();
		var c = $("textarea#data, textarea#text, textarea#directives").parents("form"),
			k = c.find('input[type="submit"]'),
			d = '<i class="fa fa-floppy-o">&nbsp;&nbsp;</i>',
			b = ($("textarea#directives").length ? "-12px" : "0"),
			g = ($("select").val() ? $("select").val() : ($(".table-title").text() ? $(".table-title").text() : ($(".panel-body tt:first").text() ? $(".panel-body tt:first").text() : "xx"))),
			j = '<span class="cspinner_container" style=" width: 19px; height: 14px; display: inline-block;"><span class="cspinner" style="margin-top: -4px; margin-left: -11px;"><span class="cspinner-icon white small"></span></span></span>',
			h = '<span class="cspinner_container" style=" width: 19px; height: 14px; display: inline-block;"><span class="cspinner" style="margin-top: -4px; margin-left: -11px;"><span class="cspinner-icon dark small"></span></span></span>';
		k.parents("table.ui_form_end_buttons").prev("br").remove();
		k.parents("table.ui_form_end_buttons").prev("div.table-responsive").attr("style", "margin-bottom: -4px !important");
		k.replaceWith('			<span class="btn-group" style="margin-top: ' + b + '">				<button type="button" class="btn btn-success margined-top-5" data-form="submitter" data-form-onbeforeunload="0">' + d + lang("theme_xhred_global_save") + '&nbsp;</button>				<button type="submit" class="btn btn-default margined-top-5"><i class="fa fa-arrow-circle-o-left">&nbsp;&nbsp;</i>' + lang("theme_xhred_global_save_and_close") + "&nbsp;</button>			</span>		");
		var a = $('button[type="button"]'),
			f = $('button[type="submit"]');
		window.__cm_editor_static.on("change", function (n, l) {
			__cm_editor_static.save();
			a.addClass("btn-warning").removeClass("btn-success").attr("data-form-onbeforeunload", 1)
		});
		$("body").on("keydown", function (l) {
			if (l.keyCode == 13 && l.ctrlKey && !l.shiftKey) {
				a.trigger("click")
			} else {
				if (l.keyCode == 13 && l.ctrlKey && l.shiftKey) {
					f.trigger("click")
		...
		$('body button[type="submit"]').on("click", function (l) {
			$("button").find(".fa.fa-arrow-circle-o-left").replaceWith(h);
			a.attr("data-form-onbeforeunload", 0)
		});
		$('body button[data-form="submitter"]').on("click", function (m) {
			m.preventDefault();
			var l = $(this);
			$("button").find(".fa.fa-floppy-o").replaceWith(j);
			setTimeout(function () {
				$.ajax({
					type: "POST",
					url: $_____link_full + $__current_directory + c.attr("action"),
					data: (new FormData(l.parents("form")[0])),
					dataType: "text",
					cache: false,
					contentType: false,
					processData: false,
					success: function (n) {
						...
						$("button").find(".cspinner_container").replaceWith(d);
						messenger('<i class="fa fa-check-circle">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_file_saved").replace("%value", g), 3, "success")
					},
					error: function (n) {}
				})
			}, 300)
...
function __dpt() {
	if (t__wi_p.$('li.sub_active a[href*="' + $g__o__f_m + '"]').length) {
		if ($('iframe[name="page"]').get(0) && $('iframe[name="page"]').get(0).contentWindow && $('iframe[name="page"]').get(0).contentWindow.$('body[class*="' + $g__o__f_m + '"] form input#path').val()) {
			t__wi_p.document.title = $('iframe[name="page"]').get(0).contentWindow.$('body[class*="' + $g__o__f_m + '"] form input#path').val() + " - " + t__wi_p.$("li.sub_active a").text() + " — " + $g__v__title
		} else {
	...
	if ($("body").attr("class") && $("body").attr("class").indexOf($g__o__f_m) > -1) {
		if ($__source_file == "config.cgi") {
			...
			setTimeout(function () {
				...
				$("#columns_size").next("label").remove();
				$("#columns_size").remove()
			}, 0);
		...
		if ($___relative_url.indexOf("index.cgi") === -1) {
			...
			$('#headln2l > a[href*="' + $g__o__f_m + '"][href*="index.cgi"]').addClass("hidden");
			if (settings_favorites) {
				f__dt()
			}
		}
		...
		$(".o__f_m-button-chmod a").html('<i class="fa fa-gears" aria-hidden="true"></i>&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_chmod"));
		$("#chmodDialog .modal-header h4").html('<i class="fa fa-gears" aria-hidden="true"></i>&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_chmod"));
		$(".o__f_m-button-chown a").html('<i class="fa fa-users" aria-hidden="true"></i>&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_chown"));
		$("#chownDialog .modal-header h4").html('<i class="fa fa-users" aria-hidden="true"></i>&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_chown"));
		$(".o__f_m-button-compress a").html('<i class="fa fa-file-archive-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_newarchive"));
		$("#compressDialog .modal-header h4").html('<i class="fa fa-file-archive-o" aria-hidden="true"></i>&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_newarchive"));
		$("#searchDialog .modal-header h4").html('<i class="fa fa-search" aria-hidden="true"></i>&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_search"));
		$(".o__f_m-button-copy a").html('<i class="fa fa-copy" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_copy"));
		$(".o__f_m-button-cut a").html('<i class="fa fa-cut" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_cut"));
		$('.btn-group .btn-group a[onclick="createFileDialog()"]').html('<i class="fa fa-file-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_newfile"));
		$("#createFileDialog .modal-header h4").html('<i class="fa fa-file-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_newfile"));
		$('.btn-group .btn-group a[onclick="createFolderDialog()"]').parent("li").addClass("_createFolderDialog_");
		$('.btn-group .btn-group a[onclick="createFolderDialog()"]').html('<i class="fa fa-folder-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_newfoder"));
		$("#createFolderDialog .modal-header h4").html('<i class="fa fa-folder-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_newfoder"));
		$('.btn-group .btn-group a[onclick="viewReadyForUpload()"]').html('<i class="fa fa-upload" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_upload"));
		$("#readyForUploadDialog .modal-header h4").html('<i class="fa fa-upload" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_upload"));
		$('.btn-group .btn-group a[onclick="downFromUrlDialog()"]').html('<i class="fa fa-download" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_download"));
		$("#downFromUrlDialog .modal-header h4").html('<i class="fa fa-download" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_download"));
		...
		$("#removeDialog .modal-header h4").html('<i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;&nbsp;' + lang("theme_xhred_filemanager_context_delete_selected"));
			...
			if ($source_path == $_____link + "settings-editor_read.cgi" || (product_name(1).toLowerCase() == "virtualmin" && ($current_page_full == "/apache/allmanual_form.cgi" || $current_page_full == "/apache/manual_form.cgi" || $current_page_full == "/spam/edit_manual.cgi" || $current_page_full == "/virtual-server/edit_html.cgi" || $current_page_full == "/virtual-server/apply_style.cgi" || $current_page_full == "/phpini/edit_manual.cgi" || $('body[class*="' + $g__o__f_m + '"]') && $('body[class*="' + $g__o__f_m + '"]').length)) || (product_name(1).toLowerCase() == "cloudmin" && ($('body:not([class*="' + $g__o__f_m + '"])'))) || product_name(1).toLowerCase() != "virtualmin" && product_name(1).toLowerCase() != "cloudmin" && $current_page_full != $_____link_full + "/virtualmin-sqlite/" && $current_page_full != $_____link_full + "/updown/" && $current_directory != $_____link + "firewalld/" && $current_directory != $_____link + "firewall/" && $current_directory != $_____link + "net/" && $current_directory != $_____link + "acl/" && $current_directory != $_____link + "inetd/" && $current_directory != $_____link + "nis/" && $current_directory != $_____link + "pap/" && $current_directory != $_____link + "ppp-client/" && $current_directory != $_____link + "pptp-client/" && $current_directory != $_____link + "pptp-server/" && $current_directory != $_____link + "shorewall/" && $current_directory != $_____link + "shorewall6/" && $current_directory != $_____link + "raid/" && $current_directory != $_____link + "lvm/" && $current_directory != $_____link + "fdisk/" && $current_directory != $_____link + "lpadmin/" && $current_directory != $_____link + "virtualmin-registrar/" && $current_directory && $current_directory.indexOf("cluster") === -1 && $current_file != "edit_access.cgi" && $current_file != "edit_file.cgi" && $current_file != "edit_referers.cgi" && $current_file != "edit_lock.cgi" && $current_file != "edit_mobile.cgi" && $current_file != "edit_user.cgi" && $current_file != "edit_unix.cgi" && $current_file != "edit_pass.cgi" && $current_file != "edit_dump.cgi" && $current_file != "edit_cron.cgi" && $current_file != "gbatch_form.cgi" && $current_file != "batch_form.cgi" && $current_file != "edit_score.cgi" && $current_file != "edit_ports.cgi" && $current_file != "acl.cgi" && $current_file != "edit_recs.cgi" && $current_file != "edit_dirs.cgi" && $current_page_full != $_____link_full + "/config.cgi" && $current_page_full != $_____link_full + "/backup-config/edit.cgi" && $current_page_full != $_____link_full + "/updown/index.cgi" && $current_page_full != $_____link_full + "/apache/edit_defines.cgi" && $current_page_full != $_____link_full + "/apache/edit_gmime_type.cgi" && $current_page_full != $_____link_full + "/fail2ban/edit_filter.cgi" && $current_page_full != $_____link_full + "/fail2ban/edit_action.cgi" && $current_page_full != $_____link_full + "/fail2ban/edit_jail.cgi" && $current_page_full != $_____link_full + "/usermin/edit_configs.cgi" && $current_page_full != $_____link_full + "/virtualmin-support/ticket.cgi" && $current_page_full != $_____link_full + "/virtualmin-support/login.cgi" && $current_page_full != $_____link_full + "/webminlog/view.cgi" && $current_page_full != $_____link_full + "/bind8/slave_form.cgi" && $current_page_full != $_____link_full + "/bind8/stub_form.cgi" && $current_page_full != $_____link_full + "/bind8/mass_form.cgi" && $current_page_full != $_____link_full + "/mysql/exec_form.cgi" && $current_page_full != $_____link_full + "/postgresql/exec_form.cgi" && $('body[class*="' + $g__o__f_m + '"]') && $__source_file != "config.cgi") {
				...
				setTimeout(function () {
					if (!$("body").find(".jsPanel").length) {
						$(".CodeMirror").before('<i class="fa fa-lg fa-question-circle text-muted -helper __helper"></i>')
					}
...
$('body:not([class*="' + $g__o__f_m + '"])').on("keydown", function (g) {
...
if (t___wi.location == t__wi_p.location) {
	...
	if (t__wi_p.$___________initial === 1) {
		console.log("Welcome to Authentic Theme 17.80 https://github.com/qooob/authentic-theme")
	}
	$.ajax({
		type: "GET",
							...
							if (h == "local_time" || h == "uptime" || h == "running_proc") {
								...
								if (h == "local_time" && settings_window_replace_timestamps) {
									if (f && f.length) {
										...
										g.html(f.html(moment.unix(j).format(settings_window_replaced_timestamp_format_full)))
									} else {
										j = $(a).find('span[data-id="sysinfo_' + h + '"] > span').data("convertible-timestamp-full");
										g.html(moment.unix(j).format(settings_window_replaced_timestamp_format_full))
									}
								} else {
	...
	$(window).keydown(function (k) {
		var l = t__wi_p.$(".form-control.sidebar-search").val(),
			g = (typeof t__wi_p.$(".form-control.sidebar-search").val() != "undefined");
		if ((g && (!l.trim() || l.trim().startsWith("!"))) && (k.keyCode == 38 || k.keyCode == 40)) {
			...
			k.preventDefault();
			k.stopPropagation();
			__shell_commands__i__ = k.keyCode == 40 ? ++__shell_commands__i__ : --__shell_commands__i__;
			if (__shell_commands__i__ < 0) {
				__shell_commands__i__ = h - 1
			}
			if (c[__shell_commands__i__ % h]) {
				t__wi_p.$(".form-control.sidebar-search").val(c[__shell_commands__i__ % h])
			}
			return
		} else {
			if (g && l.trim().startsWith("!") && k.keyCode == 27) {
				k.preventDefault();
				k.stopPropagation();
				t__wi_p.$(".form-control.sidebar-search").val("");
				return
		...
		if (g && l.trim().startsWith("!") && k.keyCode == 13) {
			var f = JSON.parse(localStorage.getItem("shell_commands")),
				b = [],
				d = l.trim();
			for (var j in f) {
				b.push(f[j])
		...
		if (g && l.trim().startsWith("!") && k.keyCode == 13 && product_name(1).toLowerCase() != "cloudmin") {
			...
			if (t__wi_p.$('iframe[name="page"]').contents() && t__wi_p.$('iframe[name="page"]').contents().find("body").data("shell") == "1") {
				$__shell_form = '<form class="__shell_form__" role="form" action="' + $_____link_full + '/shell/index.cgi" method="post" enctype="multipart/form-data">									<input type="hidden" id="cmd" name="cmd" value="' + l.trim().substring(1).trim() + '">								</form>';
			...
			if (g && l.trim().startsWith("!") && k.keyCode == 13 && product_name(1).toLowerCase() == "cloudmin") {
				...
				if (t__wi_p.$('iframe[name="page"]').contents() && t__wi_p.$('a[target="page"][href*="/server-manager/save_serv.cgi"]').length && t__wi_p.$('a[target="page"][href*="shell=1"]').length) {
					$__shell_form = '<form class="__shell_form__" role="form" action="' + $_____link_full + '/server-manager/shell.cgi" method="post" enctype="multipart/form-data">									<input type="hidden" id="id" name="id" value="' + t__wi_p.$("#sid").val() + '">									<input type="hidden" id="cmd" name="cmd" value="' + l.trim().substring(1).trim() + '">								</form>';
					t__wi_p.$('iframe[name="page"]').contents().find("body").append($__shell_form);
					t__wi_p.$('iframe[name="page"]').contents().find(".__shell_form__").submit();
					__cms();
	...
	function __f____a(j, g) {
		...
		if (j === "copy" || j === "cut") {
			...
			$.ajax({
				...
				success: function (a) {
					...
					if (j === "copy") {
						setTimeout(function () {
							messenger('<i class="fa fa-clone">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_copying_successful"), 5, "success")
						}, 10)
					} else {
						if (j === "cut") {
							setTimeout(function () {
								messenger('<i class="fa fa-scissors">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_cutting_successful"), 5, "warning")
							}, 10)
						}
					}
				},
		...
		if (j === "paste") {
			$.ajax({
				type: "POST",
				url: $g__e__path + "/file-manager/paste.cgi?path=" + l + "&module=" + $g__m__name,
				data: false,
				dataType: "text",
				success: function (c) {
					var b = (get_cookie("file-manager-response_count") == "1" ? 1 : 2);
					var a = get_cookie("file-manager-response");
					if (a.indexOf("err") === -1) {
						delete localStorage.cut;
					...
					if ((!$(c).find("#list_form").length && a != "cc" && a != "ep" && a != "merr") || a == "err") {
						messenger('<i class="fa fa-exclamation-triangle">&nbsp;&nbsp;&nbsp;</i>' + $(c).find(".panel-body").html(), 10, "error");
						__f_____ul()
					} else {
						if (a == "merr") {
							messenger('<i class="fa fa-exclamation-triangle">&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_move_into_self"), 10, "error");
							__f_____ul()
						} else {
							if (a == "ep") {
								bootbox.dialog({
									message: lang("theme_xhred_filemanager_target_conflic_message_" + b + ""),
									title: '<i class="fa fa-exclamation-circle font-size-80p bootbox-o__f_m-save-prompt">&nbsp;&nbsp;</i> <strong class="font-size-90p">' + lang("theme_xhred_filemanager_target_conflic_" + b + "") + "</strong>",
									buttons: {
										success: {
											label: '&nbsp;<i class="fa fa-clipboard">&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_target_conflic_paste") + "&nbsp;&nbsp;",
											className: "btn-primary vertical-align-top ",
											callback: function () {
												$.ajax({
													type: "POST",
													url: $g__e__path + "/file-manager/paste.cgi?path=" + l + "&module=" + $g__m__name + "&ua=2",
													data: false,
													dataType: "text",
													success: function (d) {
														messenger('<i class="fa fa-clipboard">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_pasting_and_copying_" + b + ""), 5, "success");
														__f___u("upd", $(d).find("#list_form table").find(".ui_checked_columns"), 1, j)
													},
													error: function (d) {}
												})
											}
										...
										danger: {
											label: '&nbsp;<i class="fa fa-times-circle-o">&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_target_conflic_replace") + "&nbsp;&nbsp;",
											className: "btn-danger vertical-align-top margined-left--2",
											callback: function () {
												$.ajax({
													type: "POST",
													url: $g__e__path + "/file-manager/paste.cgi?path=" + l + "&module=" + $g__m__name + "&ua=1",
													data: false,
													dataType: "text",
													success: function (d) {
														messenger('<i class="fa fa-clipboard">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_pasting_and_replacing_" + b + ""), 5, "success");
														__f___u("upd", $(d).find("#list_form table").find(".ui_checked_columns"), 1, j)
													},
													error: function (d) {}
												})
								...
								if (a == "cc") {
									messenger('<i class="fa fa-clipboard">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_pasting_and_copying_" + b + ""), 5, "success");
									__f___u("upd", $(c).find("#list_form table").find(".ui_checked_columns"), 1, j)
								} else {
									messenger('<i class="fa fa-clipboard">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_pasting_successful"), 5, "success");
									__f___u("upd", $(c).find("#list_form table").find(".ui_checked_columns"), 1, j)
								}
							}
						}
		...
		if (j === "extract") {
			$.ajax({
				...
				success: function (a) {
					...
					messenger('<i class="fa fa-file-archive-o">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_extracting_archive") + " " + lang("theme_xhred_global_please_wait"), 5, "info");
		...
		if (j === "bookmark") {
			...
			$.ajax({
				type: "POST",
				url: $g__e__path + "/file-manager/" + g + "&module=" + $g__m__name,
				data: false,
				dataType: "text",
				success: function (a) {
					exiting_book_mark = f_m__bm__u();
					if (exiting_book_mark.length) {
						messenger('<i class="fa fa-star-o">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_unbookmark_success").replace("%value", (l ? l : "/")), 5, "warning")
					} else {
						messenger('<i class="fa fa-star">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_bookmark_success").replace("%value", (l ? l : "/")), 5, "info")
					}
				},
				error: function (a) {}
			})
		...
		if (j === "search") {
			...
			modal_dismiss();
			messenger('<i class="fa fa-search">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_searching").replace("%value", $('#searchForm input[name="query"]').val()) + " " + lang("theme_xhred_global_please_wait"), 5, "info");
			$.ajax({
				type: "POST",
				...
				success: function (a) {
					...
					$_br.html($_br.html() + '<span class="__o__f_m-search-results">' + ($(".breadcrumb > li:last-child a i").hasClass("fa-search") ? "&nbsp;&nbsp;&nbsp;/&nbsp;" : "") + '&nbsp;&nbsp;:&nbsp;&nbsp;<span class="text-primary __o__f_m-search-results-data cursor-pointer">`<em>' + k + "</em>`</span></span>");
					if (__list_table_total_rows > 1) {
						messenger('<i class="fa fa-search">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_search_founds").replace("%value", __list_table_total_rows), 5, "success")
					} else {
						if (__list_table_total_rows == 1) {
							messenger('<i class="fa fa-search">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_search_found"), 5, "success")
						} else {
							messenger('<i class="fa fa-search">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_search_no_matches"), 5, "warning")
						}
					}
					if (settings_favorites) {
						f__dt()
		...
		if (j === "chmod") {
			$("#list_form").append('<input type="hidden" name="perms" value="' + g[0] + '" class="_o__f_m-tmp-chmod-inputs">');
			$("#list_form").append('<input type="hidden" name="applyto" value="' + g[1] + '" class="_o__f_m-tmp-chmod-inputs">');
			$.ajax({
				type: "POST",
				...
				dataType: "text",
				success: function (a) {
					$("#list_form ._o__f_m-tmp-chmod-inputs").remove();
					if (!$(a).find("#list_form").length) {
						messenger('<i class="fa fa-exclamation-triangle">&nbsp;&nbsp;&nbsp;</i>' + $(a).find(".panel-body").html(), 10, "error");
						__f_____ul();
						return
		...
		if (j === "chown") {
			$("#list_form").append('<input type="hidden" name="owner" value="' + g[0] + '" class="_o__f_m-tmp-chown-inputs">');
			$("#list_form").append('<input type="hidden" name="group" value="' + g[1] + '" class="_o__f_m-tmp-chown-inputs">');
			$("#list_form").append('<input type="hidden" name="recursive" value="' + g[2] + '" class="_o__f_m-tmp-chown-inputs">');
			$.ajax({
				type: "POST",
				...
				dataType: "text",
				success: function (a) {
					$("#list_form ._o__f_m-tmp-chown-inputs").remove();
					if (!$(a).find("#list_form").length) {
						messenger('<i class="fa fa-exclamation-triangle">&nbsp;&nbsp;&nbsp;</i>' + $(a).find(".panel-body").html(), 10, "error");
						__f_____ul();
						return
		...
		if (j === "compress") {
			$("#list_form").append('<input type="hidden" name="arch" value="' + g[0] + '" class="_o__f_m-tmp-compress-inputs">');
			$("#list_form").append('<input type="hidden" name="method" value="' + g[1] + '" class="_o__f_m-tmp-compress-inputs">');
			modal_dismiss();
			$.ajax({
				type: "POST",
				...
				dataType: "text",
				success: function (a) {
					$("#list_form ._o__f_m-tmp-compress-inputs").remove();
					if (!$(a).find("#list_form").length) {
						messenger('<i class="fa fa-exclamation-triangle">&nbsp;&nbsp;&nbsp;</i>' + $(a).find(".panel-body").html(), 10, "error");
						__f_____ul();
						return
	...
	function __f___u(r, p, k, q) {
		...
		if (typeof localStorage["DataTables_DataTables_Table_0_/" + __f___mn() + "/index.cgi"] != "undefined") {
			_filemanager_data = JSON.parse(localStorage["DataTables_DataTables_Table_0_/" + __f___mn() + "/index.cgi"])
		} else {
		...
		var m = ($.inArray($("#headln2r > a[data-config-pagination]").data("config-pagination"), [5, 10, 15, 20, 25, 30, 35, 40, 50, 100, 250, 500, 1000]) > -1 ? $("#headln2r > a[data-config-pagination]").data("config-pagination") : 25),
			...
			o = ((_filemanager_data.length && !l) ? (l ? l : _filemanager_data.length) : m);
		...
		_f__table = $("#list_form > table").dataTable({
			...
			fnDrawCallback: function (b) {
				...
				if (c > 1 && settings_thirdparty_filemanager_hide_actions == true) {
					$("#list_form table thead th").eq(c).addClass("hidden");
					d.find(".fa-font").parents("td").addClass("hidden")
				}
				$("#DataTables_Table_0_previous > a").html('<i class="fa fa-angle-left"></i>').css("border-top-left-radius", "0").css("border-bottom-left-radius", "0");
				$("#DataTables_Table_0_next > a").html('<i class="fa fa-angle-right"></i>').css("border-top-right-radius", "0").css("border-bottom-right-radius", "0");
				...
				d.find(".fa-arrow-right").removeClass("fa-arrow-right").addClass("fa-folder-open-o").css("margin-right", "30px").css("margin-left", "30px").parent("a").addClass("o__f_m-follow-file");
			...
			initComplete: function (b) {
				...
				$("body").on("keydown", function (c) {
					...
					if ((h == 46 || h == 113 || h == 114 || h == 115 || h == 116 || h == 117 || h == 119) && !_f__table.dataTable().$("tr.hl-aw", {
						...
						messenger('<i class="fa fa-exclamation-circle">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_nothing_is_selected"), 3, "warning");
						return
					}
					...
					if (h == 8 && !$(".o__f_m-main-spinner").is(":visible") && !$("input").is(":focus")) {
						if (!$(".modal.in").length) {
							c.preventDefault();
							c.stopPropagation();
							$('#headln2l > a[href*="' + $g__o__f_m + '"][href*="index.cgi"]:not(.hidden)').trigger("click")
						}
					}
					if (h == 32) {
						if (!$(".modal.in").length) {
					...
					if (h == 115 && !c.shiftKey) {
						if (!$(".modal.in").length) {
							if ($("#list_form table tbody tr.m-active").find("i.fa-edit").parent("a").length) {
								...
								window[u] = $.jsPanel({
									ajax: {
										...
										autoload: false,
											...
											C.find(".jsPanel-hdr .jsPanel-hdr-r").append('<div class="jsPanel-btn-save _filemanager_file_editor_save" style="margin-right: 10px; margin-top: 5px;"><i class="fa fa-floppy-o"></i></div>																										 <div class="jsPanel-btn-help " style="margin-right: 10px; margin-top: 5px;"><i class="fa fa-question-circle __helper"></i></div>');
											...
											C.find("._filemanager_file_editor_save").click(function (x) {
											...
											function K() {
												var x = C.find("._filemanager_file_editor_save");
											...
											C.find('form[action="save_file.cgi"]').submit(function (x) {
												x.preventDefault();
												x.stopPropagation();
												messenger('<i class="fa fa-floppy-o">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_saving_file").replace("%value", J) + " " + lang("theme_xhred_global_please_wait"), 2, "info");
												$.ajax({
													type: "POST",
													...
													dataType: "text",
													success: function (L) {
														var M = C.find("._filemanager_file_editor_save .cspinner");
														...
														messenger('<i class="fa fa-check-circle">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_file_saved").replace("%value", J), 3, "success");
														K()
													},
													error: function (A) {}
												})
									...
									onbeforeclose: function () {
										...
										if (this.find("._filemanager_file_editor_save.text-danger").length) {
											...
											bootbox.dialog({
												...
												title: '<i class="fa fa-question-circle font-size-80p bootbox-o__f_m-save-prompt">&nbsp;&nbsp;</i> <strong class="font-size-90p">' + $this.find(".jsPanel-title strong").text() + "</strong>",
												buttons: {
													success: {
								...
								messenger('<i class="fa fa-exclamation-circle">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_not_editable"), 5, "warning")
							}
						}
					}
						...
						if (h == 116) {
							if (!$(".modal.in").length) {
								...
								if ($("#list_form table tbody tr.m-active").find("i.at-font-box-remove").parent("a").length) {
									...
									messenger('<i class="fa fa-exclamation-circle">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_not_decompressable"), 5, "warning")
								}
								return
							}
						}
						...
						if (String.fromCharCode(h).toLowerCase() == "c") {
							if (!$(".modal.in").length && !$(".popover").is(":visible") && !$("input.popover-path-input").is(":focus")) {
								...
								if (!$(".o__f_m-button-copy.disabled").length) {
									...
									messenger('<i class="fa fa-exclamation-triangle">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_no_selection_to_copy"), 5, "error")
								}
								return
							}
						}
						if (String.fromCharCode(h).toLowerCase() == "v") {
							if (!$(".modal.in").length && !$(".popover").is(":visible") && !$("input.popover-path-input").is(":focus")) {
								...
								if (!$(".o__f_m-button-paste.disabled").length) {
									...
									messenger('<i class="fa fa-clipboard">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_empty_clipboard"), 5, "error")
								}
								return
							}
						}
						if (String.fromCharCode(h).toLowerCase() == "x") {
							if (!$(".modal.in").length && !$(".popover").is(":visible") && !$("input.popover-path-input").is(":focus")) {
								...
								if (!$(".o__f_m-button-cut.disabled").length) {
									...
									messenger('<i class="fa fa-exclamation-triangle">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_no_selection_to_cut"), 5, "error")
								}
								return
							}
						}
			...
			destroy: true,
			oLanguage: {
				sEmptyTable: lang("theme_xhred_datatable_semptyfolder"),
		...
		if (q === "extract") {
			messenger('<i class="fa fa-file-archive-o">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_successful_extraction"), 5, "success")
		} else {
			if (q === "delete") {
				messenger('<i class="fa fa-trash-o">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_successful_deletion"), 5, "success")
			} else {
				if (q === "chmod") {
					messenger('<i class="fa fa-cogs">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_successful_permissions"), 5, "success")
				} else {
					if (q === "chown") {
						messenger('<i class="fa fa-users">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_successful_ownership"), 5, "success")
					} else {
						if (q === "compress") {
							messenger('<i class="fa fa-file-archive-o">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_successful_compression"), 5, "success")
						} else {
							if (q === "rename") {
								messenger('<i class="fa fa-i-cursor">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_successful_rename"), 5, "success")
							} else {
								if (q === "create_folder") {
									messenger('<i class="fa fa-folder">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_successful_folder_creation").replace("%value", $('#createFolderForm input[name="name"]').val()), 5, "success")
								} else {
									if (q === "create_file") {
										messenger('<i class="fa fa-file">&nbsp;&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_successful_file_creation").replace("%value", $('#createFileForm input[name="name"]').val()), 5, "success")
									}
								}
							}
						}
	...
	function f_m__bm__cm() {
		...
		setTimeout(function () {
			if (!$(".file-manager-remove-bookmark").length) {
				$.each($('.dropdown-menu.at-o__f_m-favorites-dropdown > li:not(.data-context-bookmarks) > a:not([href^="bookmark.cgi"])'), function (f, g) {
					$(this).prepend('<i class="fa fa-minus-circle pull-right file-manager-remove-bookmark"></i>')
				})
			}
	...
	function f_m__bm__c() {
		...
		$.each($(".btn-group > .at-o__f_m-favorites-dropdown").find('li a[href*="index.cgi?path=/"]'), function () {
			if ($(this).text() == a) {
				$(this).parents(".at-o__f_m-favorites-dropdown").find('a[href^="bookmark.cgi?path="]').html('<i class="fa fa-star" aria-hidden="true">&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_unbookmark"));
				return false
			} else {
				$(this).parents(".at-o__f_m-favorites-dropdown").find('a[href^="bookmark.cgi?path="]').html('<i class="fa fa-star-o" aria-hidden="true">&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_bookmark"))
			}
		}).promise().done(function () {
			setTimeout(function () {
				f_m__bm__cm()
	...
	function f_m__bm__u() {
		...
		if (a.length) {
			a.parents(".at-o__f_m-favorites-dropdown").find('a[href^="bookmark.cgi?path="]').html('<i class="fa fa-star-o" aria-hidden="true">&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_bookmark"));
			a.parent("li").remove()
		} else {
			$(".btn-group > .at-o__f_m-favorites-dropdown").find('a[href^="bookmark.cgi?path="]').html('<i class="fa fa-star" aria-hidden="true">&nbsp;&nbsp;</i>' + lang("theme_xhred_filemanager_unbookmark"));
			$("body").find("ul.dropdown-menu.at-o__f_m-favorites-dropdown").append('<li><a href="index.cgi?path=' + b + '" style="padding-left: 12px;"><i class="fa fa-minus-circle pull-right file-manager-remove-bookmark"></i>' + b + "</a></li>")
		}
		f_m__bm__cm();
		return a
	}
	...
	function __f____r(k, n, m, h) {
		if (k === "get") {
			if ($("body").find("#list_form table tbody").hasClass("o__f_m-updating")) {
				return
			}
			...
			$.ajax({
				type: "POST",
				url: $_____link_full + "/" + __f___mn() + "/" + n + "&stripped=1",
				data: false,
				dataType: "text",
				success: function (a) {
					if (!$(a).find("#list_form").length) {
					...
					if (l) {
						$('#headln2l > a[href*="' + $g__o__f_m + '"][href*="index.cgi"]').removeClass("hidden")
					} else {
						$('#headln2l > a[href*="' + $g__o__f_m + '"][href*="index.cgi"]').addClass("hidden")
					}
				...
				$(b).on("click", "td", function (d) {
					if ($(b).find("a[href]") && !$("body").hasClass("servers")) {
						var c = $(b).find("a[href]")[0],
							...
							j = f.length,
							h = ($("body").attr("class") && $("body").attr("class").indexOf($g__o__f_m) > -1),
							g = ($(c).attr("href") && $(c).attr("href").indexOf("index.cgi?path=") > -1);
						if (!h) {
							j && f.trigger("click");
							if (j && settings_window_customized_checkboxes_and_radios) {
								$(".acheckbox, .aradio").icheck("updated")
							}
						}
						if (c && ($(this).find("a").attr("href") === $(c).attr("href") || $(this).find("a").attr("href") === undefined) && !$(d.target).is("select, input, .acheckbox, .aradio") && ($(this).parent("tr").find('a[href*="download.cgi"]').length === 0)) {
							...
							if ($(c).attr("target")) {
								!j && window.open($(c).attr("href"), $(c).attr("target"))
							} else {
	...
	if ($(".opener_shown").length > 0) {
		if ($(".opener_trigger").length > 0) {
			...
			$(".opener_trigger").parent("td").addClass("_c__op_d").attr("style", "vertical-align: middle; height:37px; text-align:left; border:0; border-left:1px solid #f0f0f0; border-right:1px solid #f0f0f0; border-top:4px solid #f0f0f0; box-shadow:0 1px 1px rgba(0,0,0,.05); border-top-left-radius:0; border-top-right-radius:0");
		...
		$(function () {
			...
			$.ajax({
				...
				success: function (m) {
					...
					$('input[name^="settings_thirdparty_filemanager"], input[name="settings_sysinfo_easypie_charts_width"], input[name="settings_sysinfo_easypie_charts_scale"]').parents("td.col_value.atscontent").parent("tr.atshover").addClass("settings_option_padded");
	...
	$("body").on("hide.bs.modal", "#update_notice", function () {
		var a = $('button[data-href="#theme-info"]');
	...
	if ($current_directory == $_____link + "status/") {
		$('td > label > img[src*="images/up.gif"]:not(".ui_icon_protected")').each(function (d, f) {
			...
			g.parent("label").attr("style", "margin: -2px 0 !important;")
		});
	...
	if ($current_page_full == $_____link_full + "/virtual-server/list_sched.cgi" || $current_page_full == $_____link_full + "/ldap-server/edit_schema.cgi" || $current_page_full == $_____link_full + "/mailboxes/view_mail.cgi" || $current_page_full == $_____link_full + "/mailbox/view_mail.cgi" || $current_page_full == $_____link_full + "/mailbox/list_folders.cgi" || $current_page_full == $_____link_full + "/phpini/" || $current_page_full == $_____link_full + "/phpini/index.cgi" || $current_page_full == $_____link_full + "/fsdump/" || $current_page_full == $_____link_full + "/fsdump/index.cgi" || $current_page_full == $_____link_full + "/fdisk/" || $current_page_full == $_____link_full + "/fdisk/index.cgi" || $current_page_full == $_____link_full + "/virtualmin-awstats/" || $current_page_full == $_____link_full + "/virtualmin-awstats/index.cgi" || $current_page_full == $_____link_full + "/syslog/" || $current_page_full == $_____link_full + "/syslog/index.cgi") {
		...
		if ($current_page_full == $_____link_full + "/syslog/" || $current_page_full == $_____link_full + "/syslog/index.cgi") {
			$.each($("tr td:last-child"), function () {
				$(this).find('a[href*="save_log.cgi"][href*="view=1"]').html($(this).find('a[href*="save_log.cgi"][href*="view=1"]').text().replace(/\.\.$/, "&nbsp;")).addClass("ui_link_replaced btn btn-primary btn-xxs").removeClass("heighter-34").attr("style", "margin-top: 0 !important; margin-bottom: 0 !important; margin-right: 3px").removeClass("ui_link").prepend('<i class="fa fa-eye hidden" style="vertical-align: baseline !important">&nbsp;&nbsp;</i>')
			})
		}
	}
		...
		$.ajax({
			...
			success: function (a) {
				...
				j.popover({
					html: true,
					container: "body",
					template: '<div class="popover module-help" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>',
					title: function () {
						return $help_title
					},
					content: function () {
	...
	if ((($current_page_full.indexOf(".cgi") === -1 || $current_page_full.indexOf("link.cgi") !== -1) || $current_page_full == $_____link_full + "/proc/open_files.cgi" || $current_page_full == $_____link_full + "/webmin/edit_webmincron.cgi" || $current_page_full == $_____link_full + "/postfix/mailq.cgi" || $current_page_full == $_____link_full + "/webmin_search.cgi" || $current_page_full == $_____link_full + "/useradmin/index.cgi" || $current_page_full == $_____link_full + "/quota/list_users.cgi" || $current_page_full == $_____link_full + "/quota/list_groups.cgi" || $current_page_full == $_____link_full + "/init/index.cgi") && ($current_directory == $_____link + "webmin/" || $current_directory == $_____link + "proc/" || $source_path == $_____link + "webmin_search.cgi" || $current_directory == $_____link + "postfix/" || $current_directory == $_____link + "virtual-server/" || $current_directory == $_____link + "init/" || $current_directory == $_____link + "mount/" || $current_directory == $_____link + "custom/" || $current_directory == $_____link + "quota/" || $current_directory == $_____link + "fsdump/" || $current_directory == $_____link + "inittab/" || $current_directory == $_____link + "logrotate/" || $current_directory == $_____link + "mailcap/" || $current_directory == $_____link + "cron/" || $current_directory == $_____link + "software/" || $current_directory == $_____link + "syslog/" || $current_directory == $_____link + "useradmin/" || $current_directory == $_____link + "apache/" || $current_directory == $_____link + "webalizer/" || $current_directory == $_____link + "cpan/" || $current_directory == $_____link + "htaccess-htpasswd/" || $current_directory == $_____link + "fdisk/") || $current_page_full == $_____link_full + "/man/search.cgi" || $current_page_full == $_____link_full + "/proc/index_tree.cgi" || $current_page_full == $_____link_full + "/proc/index_user.cgi" || $current_page_full == $_____link_full + "/proc/index_size.cgi" || $current_page_full == $_____link_full + "/proc/index_cpu.cgi" || $current_page_full == $_____link_full + "/proc/index_search.cgi" || $current_page_full == $_____link_full + "/software/search.cgi" || $current_page_full == $_____link_full + "/virtual-server/index.cgi" || $current_page_full == $_____link_full + "/virtual-server/list_users.cgi" || $current_page_full == $_____link_full + "/virtual-server/edit_newplan.cgi" || $current_page_full == $_____link_full + "/virtual-server/edit_newfeatures.cgi" || $current_page_full == $_____link_full + "/virtual-server/edit_newtmpl.cgi" || $current_page_full == $_____link_full + "/virtual-server/backuplog.cgi" || $current_page_full == $_____link_full + "/package-updates/index.cgi" || $current_page_full == $_____link_full + "/virtual-server/usage.cgi" || $current_page_full == $_____link_full + "/virtual-server/search.cgi" || (($current_page_full == $_____link_full + "/fetchmail/" || $current_page_full == $_____link_full + "/filter/") && product_name() == "Usermin")) {
		$("table").each(function () {
			if ($(this).find("thead") && $(this).find("thead").length && $(this).find("thead tr th") && $(this).find("thead tr th").length > 2) {
				...
				var g = $(this).parents(".dataTables_wrapper").find(".dataTables_filter").length ? 1 : 0;
				if (g && (($('body[class="init"]').length || ($('body[class^="init"]').length && $('body[class^="init"]').attr("class").match(/\d+$/) != null)) || ($('body[class="quota"]').length || ($('body[class^="quota"]').length && $('body[class^="quota"]').attr("class").match(/\d+$/) != null)) || ($('body[class="cron"]').length || ($('body[class^="cron"]').length && $('body[class^="cron"]').attr("class").match(/\d+$/) != null)))) {
					var h = -15,
						f = $(this).parents(".dataTables_wrapper").attr("style");
					if ($('body[class^="quota"]').length) {
						h = -27
					}
					$(this).parents(".dataTables_wrapper").attr("style", "margin-top: " + h + "px !important; " + (f ? f : ""))
				}
			}
		})
	}
	...
	if ($current_page_full == $_____link_full + "/servers/" || $current_page_full == $_____link_full + "/servers/index.cgi" || $current_page_full == $_____link_full + "/webminlog/search.cgi") {
	...
	if ($('body[class*="ldap-useradmin"]').length) {
		...
		$("form > table.table.table-striped.table-condensed").parents(".dataTables_wrapper").css("margin-top", "-15px")
	}
	if ($current_page_full == $_____link_full + "/servers/" || $current_page_full == $_____link_full + "/servers/index.cgi") {
		$(".ui_checked_columns td table tr td").find('a.ui_link[href*="edit_serv.cgi"]').addClass("margined-left-4 label label-sm label-primary hidden").html('<i class="fa fa-edit"></i>');
	...
	if ($current_page_full && $current_page_full.indexOf("/sysinfo.cgi") > -1 && __num()) {
		$('#status_services-status-collapse .tr_tag .td_tag > img[src*="images/up.gif"]:not(".ui_icon_protected")').each(function (d, f) {
			var g = $(this);
			$(f).attr("src", "" + $_____link_full + "/images/check.png").css("margin-right", "3px").attr("title", $.trim(g.parent(".td_tag").text()))
		});
		$('#status_services-status-collapse .tr_tag .td_tag > img[src*="images/down.gif"]:not(".ui_icon_protected")').each(function (d, f) {
			var g = $(this);
			$(f).attr("src", "" + $_____link_full + "/images/cross.png").css("margin-right", "3px").attr("title", $.trim(g.parent(".td_tag").text()))
		});
		$('#status_services-status-collapse .tr_tag .td_tag > img[src*="images/not.gif"]:not(".ui_icon_protected")').each(function (d, f) {
			var g = $(this);
			$(f).attr("src", "" + $_____link_full + "/images/not.png").css("margin-right", "3px").attr("title", $.trim(g.parent(".td_tag").text()))
		});
		...
		function _update_time_() {
			...
			a.text(moment.unix(a.data("convertible-timestamp-full")).format(settings_window_replaced_timestamp_format_full))
		}
		$(function () {
	...
	if (settings_window_replace_timestamps) {
		$.each($("[data-convertible-timestamp-full]"), function () {
			$(this).text(moment.unix($(this).data("convertible-timestamp-full")).format(settings_window_replaced_timestamp_format_full))
		});
		$.each($("[data-convertible-timestamp-short]"), function () {
			$(this).text(moment.unix($(this).data("convertible-timestamp-short")).format(settings_window_replaced_timestamp_format_short))
		})
	}
	...
	if ($current_page_full == $_____link_full + "/virtual-server/edit_newfeatures.cgi") {
		$("td a.ui_link").addClass("ui_link_replaced btn btn-info btn-xxs").removeClass("heighter-34").attr("style", "margin-top: 0 !important; margin-bottom: 0 !important; margin-right: 3px").removeClass("ui_link").prepend('<i class="fa fa-eye hidden" style="vertical-align: baseline !important">&nbsp;&nbsp;</i>')
	}
