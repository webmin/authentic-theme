...
var
    ...
    settings_autocomplete_extra_associations_privileged = { 'en': [{ 'mysql': 'MySQL MariaDB' }, { 'virtual-server': [[ 'rename_form', 'rename alter' ], [ 'edit_newmysqls', 'MySQL MariaDB' ], [ 'dkim', 'DKIM' ], [ 'edit_domdkim', 'DKIM' ], [ 'dnsclouds', 'AWS Amazon Route 53' ], [ 'list_clouds', 'AWS Amazon S3 Rackspace Cloud Files Google Cloud Storage Dropbox Backblaze' ]] }] };
//
//
//