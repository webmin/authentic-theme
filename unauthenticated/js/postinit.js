...
const __ua__ = window.navigator.userAgent,
    ...
    ___is_Safari = (navigator.vendor && navigator.vendor.indexOf("Apple") > -1 && navigator.userAgent && !navigator.userAgent.match("CriOS"));
if ($webprefix) {
...
function f__toogle_palette() {
    var b = $("body .user-link.palette-toggle"),
        g = (b.find(".fa-sun").length ? 0 : 1),
        a = t__wi_p.$('iframe[name="page"]').contents(),
        j = (typeof a != "undefined" && a.contents() && a.contents().get(0)),
        f = (typeof a != "undefined" && a.contents() && a.contents().length ? a.contents() : false),
        d = t__wi_p.$("html").attr("data-night-mode"),
        e = t__wi_p.$("body").attr("data-default-theme"),
        i = t__wi_p.$("html").attr("data-default-background-style"),
        h = "input, textarea",
        k = $(h).is(":focus");
    if (j) {
        if (f.find(h).is(":focus") || k) {
            return
        }
    }
    if (!j) {
    ...
    var c = ((t__wi_p.page.$source_path == t__wi_p.page.$_____link + "sysinfo.cgi" && $access_level == "0") ? 330 : 0);
    if (c) {
    ...
    setTimeout(function() {
        if (g === 1) {
            b.find(".fa-moon").removeClass("fa-moon").addClass("fa-sun vertical-align-middle");
            $(t__wi_p.page.document).find(".settings_navigation_color_toggle").addClass("hidden");
            var l = $(t__wi_p.top.document).find('head link[href*="palettes"][data-palette]');
            ...
            b.find(".fa-sun").removeClass("fa-sun vertical-align-middle").addClass("fa-moon");
            var m = $(t__wi_p.top.document).find('head link[href*="gunmetal"]');
            t__wi_p.$("body").attr("data-default-theme") != "blue" && $(t__wi_p.top.document).find("head").append('<link href="' + $webprefix + "/unauthenticated/css/palettes/" + e.toLowerCase() + "." + $load____ext + ".css?" + $.now() + '" rel="stylesheet" type="text/css" data-palette>');
            setTimeout(function() {
                t__wi_p.$("body").attr("data-theme", e);
                $(t__wi_p.page.document).find("body").attr("data-theme", e);
                m.remove();
                t__wi_p.$("html").attr("data-background-style", i);
                $(t__wi_p.page.document).find("html").attr("data-background-style", i);
            ...
            a.on("select2:open", function(b) {
                $.each($("select > option"), function() {
                    if ($(this).attr("style") && $(this).attr("style").indexOf("italic") > -1) {
                        var c = $(this);
                        setTimeout(function() {
                            t__wi_p.$("body").find('li[id$="' + c.attr("value") + '"]').attr("style", "color: #" + (__isNR ? "9a5150" : "e97471") + " !important;")
                        }, 1)
                    }
                })
            });
            ...
            $.each($("aside select > option"), function() {
                if ($(this).attr("style") && $(this).attr("style").indexOf("italic") > -1) {
                    if (t__wi_p.$(".select2-selection > .select2-selection__rendered").text().trim() == $(this).text().trim()) {
                        t__wi_p.$(".select2-selection > .select2-selection__rendered").attr("style", "color: #" + (__isNR ? "9a5150" : "e97471") + " !important;")
                    }
                }
            })
        }
...
function t__au__c___i(t, e) {
    ...
    t__wi_p.$('li > a[target="page"][data-href="/virtual-server/index.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/sysinfo.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/virtual-server/pro/history.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/mailbox/list_folders.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/mailbox/list_ifolders.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/mailbox/list_addresses.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/filter/edit_forward.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/filter/edit_auto.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/filter/edit_auto.cgi"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/filter/"], li:not(.menu-exclude):not(.user-link) > a[target="page"][data-href="/mailbox/edit_sig.cgi"]').each(function(a, b) {
    ...
    t__wi_p.$('li:not(.menu-exclude):not(.user-link) > a[target="page"]:not([data-href="/acl/edit_user.cgi"],[data-href="/virtual-server/index.cgi"],[data-href="/sysinfo.cgi"],[data-href="/virtual-server/pro/history.cgi"], [data-href="/mailbox/list_folders.cgi"], [data-href="/mailbox/list_ifolders.cgi"], [data-href="/mailbox/list_addresses.cgi"], [data-href="/filter/edit_forward.cgi"], [data-href="/filter/edit_auto.cgi"], [data-href="/filter/edit_auto.cgi"], [data-href="/filter/"], [data-href="/mailbox/edit_sig.cgi"])').each(function(a, b) {
...
function __p__pe_sm() {
    if (($('textarea[name="data"], textarea[name="text"], textarea[name="directives"], textarea[name="manual"]').length === 1) && ($('textarea[name="data"], textarea[name="text"], textarea[name="directives"], textarea[name="manual"]').parents("form").find('input[type="submit"]').length === 1)) {
        ...
        $("body").on("click", 'button[data-form="submitter"]:not(.disabled)', function(n) {
            n.preventDefault();
            var m = $(this),
                k = m.parents("form"),
                o = (k.attr("enctype") && k.attr("enctype").indexOf("form-data") > -1 ? 0 : 1),
                l = (o ? k.serialize() : (new FormData(k[0])));
            ...
            setTimeout(function() {
                $.ajax({
                    ...
                    success: function(p) {
                        ...
                        if ($(p).find(".panel-body > hr + h3").length && !$(p).find(".panel-body .table").length && !$(p).find(".panel-body form[action]").length) {
                            messenger('<i class="fa fa-lg fa-fw fa-exclamation-triangle"></i>' + $(p).find(".panel-body hr + h3").html(), 60, "error", "magic_save_error");
...
function __sam(e, i) {
    if (i === false) {
        ...
        if ($current_page_full == $_____link_full + "/virtual-server/pro/history.cgi") {
            __cms();
            t__wi_p.$('a[data-href="/virtual-server/pro/history.cgi"]').parent("li:not(.menu-exclude):not(.user-link)").addClass("sub_active").append('<span class="current-large"></span>')
        } else {
...
function __dlm(b) {
    if (t__wi_p.$___________m_locked === 1 || $source_path == $_____link + "settings-user.cgi") {
        return
    }
        ...
        $.each(n, function(u, w) {
            ...
            if (v__cm___init() || $(".jsPanel").length || q) {
                ...
                setTimeout(function() {
                    ...
                    var C = $(".fa.fa-question-circle.__helper, .__helper___");
                    C.popover({
                        container: "body",
