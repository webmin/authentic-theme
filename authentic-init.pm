    ...
    if ( $args[3] eq '1' ) {
        ...
        foreach my $css (@css) {
            print '<link href="'
                ...
                . '.css?1807" rel="stylesheet" type="text/css">' . "\n";
        }
        ...
        foreach my $js (@js) {
            ...
            print '<script src="'
                ...
                . $js . '.'
                . ( $args[2] eq 'debug' ? 'src' : 'min' )
                . '.js?1807" type="text/javascript"></script>' . "\n";
        }
    }
    else {
        ...
        if ( length $__settings{'settings_navigation_color'} && $__settings{'settings_navigation_color'} ne 'blue' ) {
            print '<link href="'
                ...
                . ( $args[2] eq 'debug' ? 'src' : 'min' )
                . '.css?1807" rel="stylesheet" type="text/css" data-palette>' . "\n";
        }
...
sub embed_footer {
    ...
    if ( get_env('script_name') ne '/session_login.cgi' ) {
        print '<script src="'
            ...
            . '.js?1807" type="text/javascript"></script><script>___authentic_theme_footer___ = 1;</script>' . "\n";
