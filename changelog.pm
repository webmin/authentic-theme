          ...
          <div class="modal-dialog modal-dialog-update">
            <div class="modal-content">
              ...
              <div class="modal-body" style="font-weight: 300">
                <h4>Version 18.00-18.08 (August 06, 2016) &nbsp;&nbsp;&nbsp;<i class="fa fa-star"></i></h4>
                <ul>
                  ...
                  <li>
                        Fixed bug <a class="label label-default" href="https://github.com/qooob/authentic-theme/issues/524" target="_blank">#524</a>
                        <span style=" float: right; font-size: 10px; display: inline-block; margin-top: 10px; ">18.08</span><hr>
                  </li>
                ...
                <hr>
                <span style=" float: right; font-size: 10px; display: inline-block; margin-top: -36px; ">18.00-18.07</span>
