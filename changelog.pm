          ...
          <div class="modal-dialog modal-dialog-update">
            <div class="modal-content">
              ...
              <div class="modal-body" style="font-weight: 300">
                <h4>Version 18.00-18.06 (August 01, 2016) &nbsp;&nbsp;&nbsp;<i class="fa fa-star"></i></h4>
                <ul>

                  <li>Fixed bugs <a class="label label-default" href="https://github.com/qooob/authentic-theme/issues/520" target="_blank">#520</a>
                                 <a class="label label-default" href="https://www.virtualmin.com/node/41530" target="_blank">#41530</a>

                                 <span style=" float: right; font-size: 10px; display: inline-block; margin-top: 10px; ">18.06</span><hr></li>
                ...
                <hr>
                <span style=" float: right; font-size: 10px; display: inline-block; margin-top: -36px; ">18.00-18.05</span>
