          ...
          <div class="modal-dialog modal-dialog-update">
            <div class="modal-content">
              ...
              <div class="modal-body" style="font-weight: 300">
                <h4>Version 18.30 (December 07, 2016) &nbsp;&nbsp;&nbsp;<i class="fa fa-star text-lighter margined-right-2"></i><i class="fa fa-star text-lighter margined-right-2"></i><i class="fa fa-star text-lighter margined-right-2"></i><i class="fa fa-star text-lighter margined-right-2"></i><i class="fa fa-star text-lighter margined-right-2"></i></h4>
                <ul>
