          ...
          <div class="modal-dialog modal-dialog-update">
            <div class="modal-content">
              ...
              <div class="modal-body" style="font-weight: 300">
                <h4>Version 18.00-18.05 (July 29, 2016) &nbsp;&nbsp;&nbsp;<i class="fa fa-star"></i></h4>
                <ul>

                  <li>Fixed bugs <a class="label label-default" href="https://github.com/qooob/authentic-theme/issues/516" target="_blank">#516</a>
                                 <a class="label label-default" href="https://github.com/qooob/authentic-theme/issues/517" target="_blank">#517</a>
                                 <a class="label label-default" href="https://github.com/qooob/authentic-theme/issues/518" target="_blank">#518</a>
                                 <a class="label label-default" href="https://github.com/qooob/authentic-theme/issues/519" target="_blank">#519</a>

                                 <span style=" float: right; font-size: 10px; display: inline-block; margin-top: 10px; ">18.05</span><hr></li>
                ...
                <hr>
                <span style=" float: right; font-size: 10px; display: inline-block; margin-top: -36px; ">18.00-18.04</span>
                <h4 style="margin-top:20px;">' . $Atext{'theme_development_support'} . '&nbsp;&nbsp;<i class="fa fa-fw fa-lg fa-heartbeat" style="color: #c9302c"></i></h4>
                ' . ( !licenses('cm') && !licenses('vm') ? '' : '<!--' ) . 'Thank you for using <a target="_blank" style="color: #333; font-weight: normal;" href="https://github.com/qooob/authentic-theme">' . $Atext{'theme_name'} . '</a>. Overall development of this theme has already passed the stage of <span class="badge" style="font-size: 90%; background-color: #4ca14e; border-color: #3c763d;">1800</span> hours.
