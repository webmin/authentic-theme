            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="font-weight: 300">
                ...
                <ul>
                  ...
                  <li>Added ability to open correspondent module, when clicking on charts on <em>System Information</em> page <a class="label label-default" href="https://github.com/qooob/authentic-theme/issues/480" target="_blank">#480</a><span style=" float: right; font-size: 10px; display: inline-block; margin-top: 10px; ">18.01</span><hr></li>
                ...
                <hr>
                <span style=" float: right; font-size: 10px; display: inline-block; margin-top: -36px; ">18.00</span>
