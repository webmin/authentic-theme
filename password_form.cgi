...
print '<html data-background-style="'
  ...
  . '" class="session_login">', "\n";
embed_login_head();
print '<body class="session_login" data-style="'
  . get_filters('content') . '">' . "\n";
...
print '<span class="input-group-addon"><i class="fa fa-fw fa-key"></i></span>'
  . "\n";
print
'<input type="password" class="form-control session_login" name="old" autocomplete="off" placeholder="'
  . Atext('password_old')
  . '" autocomplete="off">' . "\n";
print '</div>' . "\n";
...
print '<div class="input-group form-group">' . "\n";
print
  '<span class="input-group-addon"><i class="fa fa-fw fa-key-plus"></i></span>'
  . "\n";
print
'<input type="password" class="form-control session_login" name="new1" autocomplete="off" placeholder="'
  . Atext('password_new1')
  . '" autocomplete="off">' . "\n";
print '</div>' . "\n";
...
print
  ...
  . "\n";
print
'<input type="password" class="form-control session_login" name="new2" autocomplete="off" placeholder="'
  . Atext('password_new2')
  . '" autocomplete="off">' . "\n";
print '</div>' . "\n";
