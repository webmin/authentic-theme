...
function ___csf() {
    ...
    w.src = t__wi_p.$_____link_full + "/unauthenticated/js/jquery." + m + ".js?1803";
    p.appendChild(w);
    var p = y.contentDocument.getElementsByTagName("head")[0],
        w = y.contentDocument.createElement("script");
    w.type = "text/javascript";
    w.src = t__wi_p.$_____link_full + "/unauthenticated/js/codemirror." + m + ".js?1803";
    p.appendChild(w);
    if (!t__wi_p.$('script[src*="datatables"]').length) {
        s(t__wi_p.$_____link_full + "/unauthenticated/js/jquery.datatables." + m + ".js?1803")
    }
