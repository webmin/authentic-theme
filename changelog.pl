          ...
          <div class="modal-dialog modal-dialog-update">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                Thank you for using <a target="_blank" href="https://github.com/qooob/authentic-theme"><kbd style="background:#5cb85c">' . $text{'theme_name'} . '<kbd></a>. Overall development of this theme has already passed the stage of <span class="badge" style="background-color: #f0ad4e; border-color: #eea236;">430</span> hours.
