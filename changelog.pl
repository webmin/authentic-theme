            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <ul>
                  ...
                  <li>Improved greatly the usage of <code>autocomplete</code> for basic <em>Webmin</em> Modules. You can test it by going to <em>Running Processes</em> or <em>Perl Modules</em> and start typing in search field. Same done for most inbuilt, crucial modules</li>
                  ...
                  <li>Fixed <code>login screen</code> missing for the link to <em>Virtualmin Password Recovery</em> module, in case it\'s installed and set in <em>Webmin Configuration->Anonymous Module Access</em>. In that case, the reset button will act as expected an be the color of yellow <a href="https://github.com/qooob/authentic-theme/issues/152" target="_blank">#152</a></li>
